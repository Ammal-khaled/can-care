...
const Community = () => {
  ...
  const [posts, setPosts] = useState([
    {
      id: "PUB-001",
      title: "Treatment Day Preparation",
      content: "A short fictional guide for helping patients prepare questions and essentials before a care visit.",
      category: "Care Tips",
      image: null,
      date: "2025-12-20",
      likes: 3,
    ...
    {
      id: "PUB-002",
      title: "Managing Appointment Changes",
      content: "A reminder that registration staff can review appointment transfer requests and keep care teams informed.",
    ...
    {
      id: "PUB-003",
      title: "Supportive Care Resources",
      content: "Fictional community content for sharing calm, practical resources with CanCare users.",
      category: "Support",
      image: null,
      date: "2025-12-17",
      likes: 2,
    ...
    {
      id: "PUB-004",
      title: "Clinic Visit Reminders",
      content: "A sample announcement for reminders that would conceptually appear to connected mobile users.",
    ...
    <div className="Community-page">
      <div className="Community-header">
        <div>
          ...
          <p>Manage fictional community content designed for the connected CanCare ecosystem.</p>
        </div>
      </div>
            ...
            <div key={post.id} className="Post-card">
              ...
              <div className="Post-actions">
                ...
                <div className="Post-buttons">
                  ...
                  >
                    Like {post.likes} | Comments {post.comments.length}
                  </button>
                  <button
                    className="view-btn"
